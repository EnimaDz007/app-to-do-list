        ...
        <div className="flex-1 min-h-0 flex items-center justify-center px-3 py-2">
          <div className="relative w-full aspect-square mx-auto" style={{ maxWidth: 'min(100%, 72dvh)', maxHeight: '100%' }}>
            ...
            >
              ...
              <span className="text-[9px] font-bold text-slate-500 dark:text-slate-400  mt-1">{completionPct}% {t('done_btn').toUpperCase()}</span>
              <div className="w-[55%] h-[2px] bg-violet-200/60 dark:bg-slate-700/60 rounded mt-2 overflow-hidden">
                <motion.div
